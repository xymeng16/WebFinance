			...
			<div class="left">
				<div class="list">
					<ul class="yiji">
						...
						<li><a href="toborrow.jsp#" class="inactive">完善信息</a>
...
<%--									</ul>--%>
						...
						<li><a href="toborrow.jsp#" class="inactive">钱款操作</a>
							<ul style="display: none">
    ...
    <form action="servlet/dotoborrow" method="post" > 
    <fieldset> 
        <legend>工作详细信息</legend>
          <div> 
        ...
        <div> 
            <label>Title</label> 
            <input type="text"  name="Title"  size="18" maxlength="30" value="" /><br /> 
        </div>  
        <div> 
            <label>Rate of year(%)</label> 
            <input type="text" name="Rate"  size="18" maxlength="30" value="" /><br /> 
        </div> 
        <div> 
            <label>Target amount(ten thousand)</label> 
            <input type="text" name="Target"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>Calculation for the interest</label> 
            <input type="text" name="Calculationway"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>Waytoback</label> 
            <input type="text" name="Waytoback"  size="18" maxlength="30" value="" /><br /> 
        </div> 
        <div>
            <label>Time</label> 
            <input type="text" name="Time"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div> 
          ...
          <div> 
            ...
            <input type="text" name="Institution"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div>
