			...
			<div class="left">
				<div class="list">
					<ul class="yiji">
						...
						<li><a href="detailwork.jsp#" class="inactive">完善信息</a>
...
<%--									</ul>--%>
						...
						<li><a href="detailwork.jsp#" class="inactive">钱款操作</a>
							<ul style="display: none">
    ...
    <form action="servlet/dodetailwork" method="post" > 
    <fieldset> 
        ...
        <div> 
            ...
            <input type="text" name="Work"  size="18" maxlength="30" value="" /><br /> 
        </div> 
        <div> 
            <label>Your work place</label> 
            <input type="text" name="Workplace"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>Your income </label> 
            <input type="text" name="Income"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>Your workplace phone</label> 
            <input type="text" name="Workplacephone"  size="18" maxlength="30" value="" /><br /> 
        </div> 
        <div>
            <label>linkman</label> 
            <input type="text" name="Linkman"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div> 
            <label>linkman phone</label> 
            <input type="text" name="Linkmanphone"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div>
