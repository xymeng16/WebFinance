			...
			<div class="left">
				<div class="list">
					<ul class="yiji">
						...
						<li><a href="pay.jsp#" class="inactive">完善信息</a>
...
<%--									</ul>--%>
						...
						<li><a href="pay.jsp#" class="inactive">钱款操作</a>
							<ul style="display: none">
		...
		<div class="Width">
			...
			<form action="servlet/dopay" method="post" name="tomess" id ="tomess"> 
    <fieldset> 
        <legend>个人详细信息</legend>
        <div> 
            <label>Number you wanna pay</label> 
            <input type="text"  name="Pay"  size="18" maxlength="30" value="" /><br /> 
