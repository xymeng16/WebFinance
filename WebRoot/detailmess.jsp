			...
			<div class="left">
				<div class="list">
					<ul class="yiji">
						...
						<li><a href="detailmess.jsp#" class="inactive">完善信息</a>
...
<%--									</ul>--%>
						...
						<li><a href="detailmess.jsp#" class="inactive">钱款操作</a>
							<ul style="display: none">
    ...
    <form action="servlet/dodetailmess" method="post" enctype="multipart/form-data" name="tomess" id ="tomess"> 
    <fieldset> 
        <legend>个人详细信息</legend>
        <div> 
            <label>Your username</label> 
            <input type="text" readonly name="Username"  size="18" maxlength="30" value="<%=usern %>" /><br /> 
        </div>  
        <div> 
            <label>Your name</label> 
            <input type="text" name="Name"  size="18" maxlength="30" value="" /><br /> 
        </div> 
        <div> 
            <label>Your ID card</label> 
            <input type="text" name="IDcard"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>Testimony of IDcard</label> 
            <input type="file" name="IDcardfile"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>Your age</label> 
            <input type="text" name="Age"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>if has merried</label> 
            <input type="checkbox" name="Ismerried"  size="18" maxlength="30" value="" /><br /> 
        </div> 
        
         <div> 
            <label>if has house</label> 
            <input type="checkbox" name="Ishouse"  size="18" maxlength="30" value="" /><br /> 
        </div>
         <div> 
            <label>Testimony of house</label> 
            <input type="file" name="Housefile"  size="18" maxlength="30" value="" /><br /> 
        </div> 
         <div> 
            <label>if has car</label> 
            <input type="checkbox" name="Iscar"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div> 
            <label>Phone number</label> 
            <input type="text" name="Phone"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div> 
            <label>Your address</label> 
            <input type="text" name="Address"  size="18" maxlength="30" value="" /><br /> 
        </div>
          <div> 
            <label>Your tradepassword</label> 
            <input type="text" name="Tradepass"  size="18" maxlength="30" value="" /><br /> 
        </div>
        <div>
        <input type="submit" value="Checked" id="bottom"/>
        </div>
